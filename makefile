...
.PHONY: update_db
update_db:
	osm2pgsql-replication update -v -d gis  --max-diff-size 500 --  -G --hstore --tag-transform-script ~/src/openstreetmap-carto/openstreetmap-carto.lua -C 0 --flat-nodes ~/data/nodes.bin --number-processes 8 -S ~/src/openstreetmap-carto/openstreetmap-carto.style 
